...
const uloterapia = () => {
  return (
    <div className="app__ulo-page">
      ...
      >
        &quot; Kiedy pszczoła zniknie z powierzchni Ziemi, człowiekowi pozostaną
        już tylko cztery lata życia. <br /> Skoro nie będzie pszczół, nie będzie
        też zapylania. <br /> Zabraknie więc roślin, potem zwierząt, wreszcie
        przyjdzie kolej na człowieka... &quot; <br /> ~ Karol Darwin
      </p>
      <div className="app__ulo-page-container">
        <div className="app__ulo-text">
          <p style={{ margin: "0" }}>
            <span className="yellow-span">Apiinhalacja</span>, potocznie
            nazywana uloterapią, jest jednym z elementów stosowanej w medycynie
            naturalnej tzw. Apiterapii, czyli leczenia produktami pszczelego
            pochodzenia.
          </p>
          <p style={{ margin: "1rem 0 0 0" }}>
            ...
            dorosłych. Pszczoły nie mają bezpośredniego kontaktu z człowiekiem,
            a więc nie musimy się martwić ani koniecznością podtrzymywania
            rozmowy, ani groźbą ewentualnego użądlenia w przypadku odmiennych
            poglądów.
          </p>
          <p style={{ margin: "1rem 0 0 0" }}>
            Przy okazji bezpieczeństwa, należy również zaznaczyć, że znane z
            pracowitości pszczoły, z pedantyczną starannością dbają o czystość w
            ulu, dlatego w wdychanym powietrzu nie ma żadnych wirusów, bakterii
            ani grzybów. Z apiinhalacji mogą skorzystać zarówno dzieci jak i
            dorośli.
          </p>
          <p style={{ margin: "1rem 0 0 0" }}>
            Brak przeciwskazań terapii, sprawia, że może z niej skorzystać
            dosłownie każdy. Leczniczy wpływ produktów pszczelich znany jest od
            czasów starożytnych.Ponadto dzięki uloterapii, możemy znaleźć się
            niezwykle blisko natury, czerpiąc z niej dobrą leczniczą energię,
          </p>
          <p style={{ margin: "1rem 0 0 0" }}>
      ...
      <div className="app__ulo-more-container">
        <div className="app__ulo-more-wskazania">
          ...
          <ul className="app__ulo-page-ul">
            <li>
              Bezsenność, choroby układu nerwowego (niedowład, zapalenia nerwów,
              stwardnienie rozsiane, porażenie mózgowe)
            </li>
        ...
        <div className="app__ulo-more-knowhow">
          ...
          <ul className="app__ulo-page-ul">
            <li>
              Uloterapia dzięki swojemu uspakajającemu działaniu, wykorzystywana
              jest do leczenia pacjentów szpitali psychiatrycznych.
            </li>
            <li>
              Jednym z powodów skuteczności apiinhalacji jest korzysstne pole
              magnetyczne wytwarane przez pszczoły, którego zasięg wynosi ponad
              pół metra.
            </li>
            <li>
              Pszczoły powodują jonizację powietrza, nadając mu tym samym
              przyjazny dla człowieka ładunek. Już po pierwszym seansie odczuwa
              się polepszenie stanu fizycznego i psychicznego oraz przypływ sił
              witalnych. Jedna sesja trwa 30min. Pakiet sesji można wykorzystać
              w dowolny sposób - jednorazowy lub z podziałem na kilka sesji
              każdego dnia 10 razy po 30 minut.
            </li>
          </ul>
          <p
            style={{
